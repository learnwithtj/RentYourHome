...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Floor 1</span> <br>
										<span class="text-white">15 Moore Street, Acton</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+61 626-262-60</span>
										<span class="text-white">+61 041-424-340</span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">info@rentyourhome.com.au</span>
										<span class="text-white">accounts@rentyourhome.com.au</span>
										</div>
                                </li>
                            </ul>
                        </div>
		...
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3257.1987609097546!2d149.12519157721516!3d-35.27618419332591!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b164d678e188d87%3A0x2422e1190dae9390!2s15%20Moore%20St%2C%20Canberra%20ACT%202601%2C%20Australia!5e0!3m2!1sen!2snp!4v1728872905569!5m2!1sen!2snp" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
