                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class=" text-secondary position-relative pb-4 my-4">Instalment Calculator</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="text-secondary position-relative pb-4 mb-4">Recently Added Property</h4>
                            <ul class="property_list_widget">
